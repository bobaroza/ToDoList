...
public class Controller {
    ...
    public void initialize(){
        ...
        // binding the observable list in the ToDoData with a ListView
    ...
    //SelectionModel is a class that keeps
    // a track of witch item is selected
...
//        sb.append(item.getDeadline().toString());
    ...
    public void deleteItem(ToDoItem item){
        ...
        alert.setContentText("Are you sure? Press OK or CANCLE");
